...
logPath = "simulations/Original_uvm_test_top.env.rvfi_agent.trn.log"#"/home/giorgis/project/core-v-verif/cv32e40x/sim/uvmt/vsim_results/default/hello-world/0/uvm_test_top.env.rvfi_agent.trn.log"
branchInstrsPath = "newUVMLogs/branchInstrs.rvfi_agent.trn.log"
    #"/home/giorgis/project/branchPredictionModel/files/branchInstrs.rvfi_agent.trn.log"

takenBranchPath    = "newUVMLogs/takenBranchPath.rvfi_agent.trn.log"
notTakenBranchPAth = "newUVMLogs/notTakenBranchPAth.rvfi_agent.trn.log"

size = 100
newLogPath = "newUVMLogs/new_uvm_test_top.env.rvfi_agent.trn.log"
